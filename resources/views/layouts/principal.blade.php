...
{!! Html::style('principal/css/bootstrap.css') !!}
{!! Html::style('principal/css/style.css') !!}
{!! Html::style('principal/css/popuo-box.css') !!}
{!! Html::script('principal/js/jquery.min.js') !!}
...
<body>
	...
	<div class="footer">
		...
		{!! Html::script('principal/js/jquery.flexisel.js') !!}
